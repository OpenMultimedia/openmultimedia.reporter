...
class WorkflowTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.folder.invokeFactory('openmultimedia.reporter.anonreport', 'r1')
    ...
    def test_default_workflow(self):
        chain = self.wt.getChainForPortalType('openmultimedia.reporter.ireport')
        self.assertEqual(len(chain), 1)
        self.assertEqual(chain[0], 'ireport_workflow')

        chain = self.wt.getChainForPortalType('openmultimedia.reporter.anonreport')
        self.assertEqual(len(chain), 1)
