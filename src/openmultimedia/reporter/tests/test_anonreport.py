...
class IntegrationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.portal.invokeFactory('openmultimedia.reporter.ireport', 's1')
    ...
    def test_addable_inside_i_report_section(self):
        self.section.invokeFactory('openmultimedia.reporter.anonreport', 'r1')
        r1 = self.section['r1']
        self.assertTrue(IAnonReport.providedBy(r1))

    def test_not_globally_addable(self):
        fti = queryUtility(IDexterityFTI, name='openmultimedia.reporter.anonreport')
